# Django settings for bundproject project.
...
MEDIA_ROOT = '/home/vagrant/bund_project/media'
...
SECRET_KEY = 'ty+&amp;7y)8zj!!o%lxtt1^l*+uz4uaf%1u=b$cjkl3box^49l#-d'
...
ROOT_URLCONF = 'bundproject.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bundproject.wsgi.application'
